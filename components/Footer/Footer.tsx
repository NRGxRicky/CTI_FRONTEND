			...
			<div className='container'>
				<div className='footer__container'>
					<div className='footer__colum'>
						<div className='footer__colum__title'>INFORMACIÓN</div>
					...
					<div className='footer__colum'>
						<div className='footer__colum__title'>CONTACTAR</div>
						<div className='footer__colum__element'>
					...
					<div className='footer__colum'>
						<div className='footer__colum__title'>SERVICIO A CLIENTES</div>
						<div className='footer__colum__element'>Facturación</div>
					</div>
					<div className='footer__colum'>
						<div className='footer__colum__title'>SÍGUENOS</div>

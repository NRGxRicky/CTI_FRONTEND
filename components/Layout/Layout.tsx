  ...
  return (
    <div>
      <HeaderBar
        ...
        isMobile={isMobile}
      />
      <div className='mobile__clear-fix' style={{ height: isMobile ? '58px' : '0' }}></div>
      {children}
      <OpacityContainer opacityContainer={opacity} setParentOpacity={setParentOpacity} />
      <IconWhatsapp />
    </div>
  );
};

...
module.exports = {
	...
	async headers() {
		...
		const cspHeader = isStaging ? {
			...
			value: [
				"default-src 'self'",
				"script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.kueskipay.com https://maps.googleapis.com https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://sdk.mercadopago.com https://www.paypal.com https://www.paypalobjects.com https://*.googleapis.com https://*.gstatic.com https://*.facebook.net https://*.facebook.com https://*.doubleclick.net https://*.googletagmanager.com",
